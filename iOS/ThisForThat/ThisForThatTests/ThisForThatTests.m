...
-(void) testAddListing
{
    ...
    ListingData *l = [[ListingData alloc] initWithData:@"Tester" description:@"This is a test" photo:@"listing_photos/test.jpg" trade_completed:0 date_created: @"" date_completed: @""];
...
-(void) testAddOffer
{
    ...
    OfferData *o = [[OfferData alloc] initWithData:@"Tester" description:@"This is a test" photo:@"listing_photos/test.jpg" offer_accepted: 0 date_created: @"" date_accepted: @""];
...
-(void) testAddUser
{
    ...
    UserData *u = [[UserData alloc] initWithData:@"test user" email:"test@test.com" ];
    
    JSONInterface.addUser(l);
    assert(JSONInterface.users.count == origCount +1);
    
    UserData *u2 = JSONInterface.users.objectAtIndex:count;
